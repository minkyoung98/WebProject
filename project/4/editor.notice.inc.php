...
<main id="main" class="pl-5 pt-4 pr-5 border-left">
    ...
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">커뮤니티</a > &gt; <a href="#">공지사항</a></p>
        </div>
    </div><!-- /.blog-post -->
<div class="row">
    ...
    <form id="cate" action="../editor.php" method="post">
        ...
        if(isset($_SESSION['id'])){
            //로그인 후
            echo '<h2>공지 목록 <button type="submit" class="btn btn-secondary">글작성</button></h2>';
        }
        else{
            //로그인 전
            echo '<h2>공지 목록 <a href="/project/0/login.php"class="btn btn-secondary"><div id="button">글작성</div></a></h2>';
        }
        ?>
    </form>
        <hr>
