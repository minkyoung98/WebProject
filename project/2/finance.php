...
<?php include 'finance_section.inc.php'; ?>
...
<script>
    $(document).ready(function() {
        $('#basicNav #navInvest').addClass('clicked');
        $('#sideNav #dropInvest').show();
        $('#sideNav #dropInvest > a:nth-child(2)').css({
            'font-weight': 'bold',
            color: 'salmon'
        });
    });
    $('#sideNav #navInvest').hover(function() {
        $('#sideNav #dropInvest').show();        
    }, function() {
        $('#sideNav #dropInvest').show();
    });
