...
<main id="main" class="pl-5 pt-4 pr-5 border-left">
    <h3 class="pb-3 mb-4 font-italic border-bottom">Investment</h3>
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">투자정보</a > &gt; <a href="#">경영정보</a></p>
        </div>
        <h2 class="blog-post-title pb-2">경영정보</h2>
        <br>
        <h4>회사개요</h4>
        <ul>
            <li>회사명 : (주)그린가구</li>
            <li>설립일 : 2010년 6월</li>
            <li>대표자 : 이외숙</li>
            <li>주요생산품목 : 부엌가구, 일반가구, 드레스실가수</li>
            <li>주소 : 본사/공장-경기도 안성시 양성면 덕봉리 88-29번지<br>
                Tel. 031-673-6781~2<br>
                Fax. 031-673-6786
            </li>
        </ul>
        <br>
