...
$sql = "SELECT * FROM customer_consultation ORDER BY seq DESC ";
...
<script>
    ...
    $(document).on('click', '.table td', function(){
        ...
        //console.log(seq);
        $.get('text_form.customer_consultation.php',{
            seq: seq
        }).done(function(data){
            if($.trim(data)){
                //$('#pocket').html(data);
                location.href = 'text_form.customer_consultation.php?seq='+ seq; 
