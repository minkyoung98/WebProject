...
<div class="row">
    ...
    <form id="cate" action="../editor.php" method="post">
        ...
        if(isset($_SESSION['id'])){
            //로그인 후
            echo '<h2>주문문의 목록 <button type="submit" class="btn btn-secondary">글작성</button></h2>';
        }
        else{
            //로그인 전
            echo '<h2>주문문의 목록 <a href="/project/0/login.php"class="btn btn-secondary"><div id="button">글작성</div></a></h2>';
        }
        ?>
    </form>
        <hr>
