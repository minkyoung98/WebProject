...
<h3 class="pb-3 mb-4 font-italic border-bottom">Order Made</h3>
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">가구주문</a > &gt; <a href="#">제작과정</a></p>
        </div>
        <h2 class="blog-post-title pb-2">제작과정</h2>
        <br>   
  
    <div id="table">
    <table>
            <tr>
                <td><img src="production_process1-1.jpg"></td>
                <td>1. 가재단_원자재를 원하는 SIZE별로 가공 여유를 두고 재단을 합니다.</td>
            </tr>
            <tr>
                <td><img src="production_process1-2.jpg"></td>
                <td>2. 심재 조립_기본 틀을 이루는 심재(FRAME)를 조립하고 하니콤으로 속을 채웁니다.</td>
            </tr>
            <tr>
                <td><img src="production_process1-3.jpg"></td>
                <td>3. 합판 접착_300t 이상의 다단프레스로 조립된 심재의 상,하에 합판을 접착하여 플러쉬(FLUSH)를 제작합니다.</td>
            </tr>
            <tr>
                <td><img src="production_process1-4.jpg"></td>
                <td>4. 무늬목 접착_두께 조정을 위해 면 샌딩을 한 후 600t의 프레스로 플러쉬에 무늬목을 접착하여 판넬을 만듭니다.</td>
            </tr>
            <tr>
                <td><img src="production_process1-5.jpg"></td>
                <td>5. 정재단_만들어지 판넬을 규격에 맞추어 정밀하게 재단합니다.</td>
            </tr>
            <tr>
                <td><img src="production_process1-6.jpg"></td>
                <td>6. 에지 접착_옆면에 에지(EDGE)를 접착 합니다.</td>
            </tr>
        </table>
        <hr>
    </div>
