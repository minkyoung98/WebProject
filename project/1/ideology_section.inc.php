<section id="section">
    <div>
        ...
        <div class="right">
            <main id="main" class="border-left">
                <h3 class="pb-3 mb-4 font-italic border-bottom">Company</h3>
                <div class="blog-post">
                    <div class="location">
                        <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">회사소개</a > &gt; <a href="#">경영이념</a></p>
                    </div>
                    <h2 class="blog-post-title pb-2">경영이념</h2>
                    <br>
                    <h4>경영정책</h4>
                    <p>&lt; 고객의 삶의 질을 풍요롭고 윤택하게 하는 사랑 받는 기업 &gt;</p>
                    <ul>
                        <li><strong>품질제일</strong> 꾸준한 기술개발과 경영합리화</li>
                        <li><strong>고객만족</strong> 최고의 가치는 고객지향적 사고! 고객과 더불어 성장하고 발전함</li>
                        <li><strong>안전제일</strong> 최고의 가치는 고객지향적 사고! 고객과 더불어 성장하고 발전함</li>
                    </ul>
                    <br>
                    <h4>3정 활동</h4>
                    <ol>
                        <li><strong>정</strong>품목 : 일정한 품목을</li>
                        <li><strong>정</strong>량 : 일정한 용기에 담아서</li>
                        <li><strong>정</strong>위치 : 일정한 위치에 두는 것</li>
                    </ol>
                    <br>
                    <h4>5S 활동</h4>
                    <ol>
                        <li><strong>S</strong>EIRI : 정리</li>
                        <li><strong>S</strong>EIDON : 정돈</li>
                        <li><strong>S</strong>EISO : 청소</li>
                        <li><strong>S</strong>EIKETZ : 청결</li>
                        <li><strong>S</strong>ITSUKE : 생활화</li>
                    </ol>
                </div><!-- /.blog-post -->
            </main>
        </div>
