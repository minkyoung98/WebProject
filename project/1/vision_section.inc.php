...
<main id="main" class="pl-5 pt-4 pr-5 border-left">
    ...
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">회사소개</a > &gt; <a href="#">경영비젼</a></p>
        </div>
        <h2 class="blog-post-title pb-2">경영비젼</h2>
        <br>
        <ul>
            <li><strong>환경기업</strong> 지구 지킴이로서 기업의 역할</li>
            <li><strong>젊은기업</strong> 젊은 사고를 가지고 빠르게 변하는 시대에 맞추어 창의적인 아이디어로 변화를 선도</li>
            <li><strong>최고지향기업</strong> 최선이 아닌 최고의 품질의 제품을 위해 끊임없이 노력</li>
            <li><strong>상생추구기업</strong> 협력업체&amp;고객과의 책임의식을 갖고 나눔 경영을 실천 </li>
        </ul>
    </div><!-- /.blog-post -->
</main>
</section><!-- /section -->