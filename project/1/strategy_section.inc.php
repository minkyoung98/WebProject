...
<main id="main" class="pl-5 pt-4 pr-5 border-left">
    ...
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">회사소개</a > &gt; <a href="#">그린만의 전략</a></p>
        </div>
        <h2 class="blog-post-title pb-2">그린만의 전략</h2>
        <br>
        <h4>품질전략</h4>
        <p>&lt; 고객의 삶의 질을 풍요롭고 윤택하게 하는 사랑 받는 기업 &gt;</p>
        <ul>
            <li><strong>고객</strong><br>-> 빠른 스타일 변화에 맞추어 접점에서의 다양한 서비스 제공</li>
            <br>
            <li><strong>시장</strong><br>-> 다양한 경제업체들의 등장하고 있는 상황에서 고객유지 및 새로운 고객확보 경쟁에 따라 선진 서비스 제공 및 </li>
            <br>
            <li><strong>(주)그린가구</strong><br>-> 수십년간 축적돼온 Know-How를 바탕으로 국내 상위 가구/건설사의 우수협력업체로서 최선.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;고객접점에서의 신속하고 정확한 대응으로 고객만족을 극대화하고 있음</li>
        </ul>
    </div><!-- /.blog-post -->
</main>
</section><!-- /section -->