...
<main id="main" class="pl-5 pt-4 pr-5 border-left">
    ...
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">회사소개</a > &gt; <a href="#">사업계획</a></p>
        </div>
        <h2 class="blog-post-title pb-2">사업계획</h2>
        <br>
        <h4>주요사업내용</h4>
        <ul>
            <li><strong>주방제품</strong> 도장제품 조립, 주방가구 몸통 생산/조립, 각종 부속자재 생산/조립 걸레받이, 판넬</li>
            <li><strong>일반가구제품</strong> 거실장, 붙박이장외 아파트 반침 및 베란다 선반, 사우나 및 락커룸 옷장</li>
            <li><strong>기타가구</strong> 기타 비규격 목제품 생산. 거실장 등.</li>
        </ul>
        <br>
        <h4>주요거래처</h4>
        <ul>
            <li>가구사 : (주)우아미가구, (주)리바트, (주)우아미C&amp;F, (주)바로크, (주)에넥스, (주)엔비스, (주)골든 외 다수</li>
            <li>하드웨어 : 한라알루텍, 경양산업, 헤티, 헤펠레, 한양산업, 삼성정밀공업 외 다수</li>
        </ul>
        <br>
        <h4>사업계획</h4>
        <ol>
            <li>생산성 향상</li>
                <ul>재단능력 증대 (목표: 960매/日, 2대)</ul>
                <ul>포장능력 증대 (목표: 700BOX/日)</ul>
                <ul>재단프로그램 도입(자체시스템) 및 수율 관리</ul>
                <ul>공정별 일단위 목표 설정</ul>
            <li>설비 추가 및 LAY-OUT 변경</li>
                <ul>노후장비 교치 및 JIT(시조)라인 증설</ul>
                <ul>설비 추가 목록</ul>
            <li>유기적인 협조체계 구축</li>
                <ul>계획생산 시스템 구축</ul>
                <ul>공정별 숙련공 육성</ul>
                <ul>공장내 식당 및 휴게소 설치</ul>
            <li>청정 및 개선활동 강화</li>
                <ul>3정5S 지속적 활동</ul>
                <ul>개선제안활동 강화</ul>
                <ul>바닥 에폭시 작업 및 구획선 설정</ul>
            <li>조직운영계획</li>
        </ol>
    </div><!-- /.blog-post -->
</main>
