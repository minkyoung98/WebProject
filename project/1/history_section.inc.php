...
<main id="main" class="pl-5 pt-4 pr-5 border-left">
    ...
    <div class="blog-post">
        <div class="location">
            <p><a href="/project/index.php">메인화면</a> &gt; <a href="#">회사소개</a > &gt; <a href="#">연혁</a></p>
        </div>
        <h2 class="blog-post-title pb-2">연혁</h2>
        <br>
        <ol>
            <li>2010년 6월 : (주)아데코 설립</li>
            <li>2010년 6월 : 우아미 가구내 공장가동</li>
            <li>2011녀 8월 : 사업장 상호변경</li>
            <li>2011년 8월 : 우아미가구 년간 계약체결</li>
            <li>2011년 9월 : (주)두진건설 계약체결</li>
            <li>2013년 10월 : 상호변경 법인 설립</li>
        </ol>
    </div><!-- /.blog-post -->
</main>
</section><!-- /section -->